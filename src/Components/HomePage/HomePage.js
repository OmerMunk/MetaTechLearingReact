...
const HomePage = () => {
    ...
    return (
        <div style={{overflowX:'hidden'}}>
            ...
            <div className="homePage">
                ...
                <header
                    ...
                    style={{
                        ...
                        left: '10%',
                        width: '80%',
                        transform: `scale(${1 - size * 0.0005}) rotate(${0 - size * 0.0225}deg)`,
                    }}
                >
                    <span className="m-4">
          ...
          <p style={{fontSize: '35px', background: 'transparent', border: 'none', boxShadow: 'none', fontWeight: 600}}
             className="card">
            ...
            <button onClick={() => {
            ...
            }} className="benBtn autoMarg">Join Us</button>
          </p>
        </span>
                ...
                <section className="card text-center"
                         style={{
                             ...
                             transform: `scale(${0.5 + size * 0.0005}) skewY(${-10 +size*0.01}deg)`,
                             marginBottom: '20%',
                             maxWidth:'2000px'
                         }}>
                    ...
                    >Start Learning Now</h3>
                    <hr/>
                    <div className=" homePage homeFlex">
                        <p className="card cardItem">
                            Java
                            <img
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTlWkibXFdfUB7h7FmKLmgwxe-__BdMPGNGDA&usqp=CAU" alt='JavaLogo'/>
                        </p>
                        <p className="card cardItem">
                            Python{" "}
                            <img src="https://img.cppng.com/download/2020-06/7-2-python-logo-free-download-png.png" alt='PythonLogo'/>
                        </p>
                        <p className="card cardItem">
                            HTML
                            <img
                                src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/HTML5_logo_and_wordmark.svg/512px-HTML5_logo_and_wordmark.svg.png" alt='HTMLLogo'/>
                        </p>
                        <p className="card cardItem">
                            JS
                            <img
                                src="https://i2.wp.com/thebamboocode.com/wp-content/uploads/2016/03/js-logo.png?fit=500%2C500" alt='JavaScriptLogo'/>
                        </p>
                        <p className="card cardItem">
                            CSS
                            <img src="https://cdn-icons-png.flaticon.com/512/919/919826.png" alt='CSSLogo'/>
                        </p>
                        <p className="card cardItem">
                            C/C++{" "}
                            <img src="https://i.pinimg.com/originals/6e/46/e7/6e46e7dbe2bb73dacc055e5dbd85c3ad.png" alt='CCPPLogo'/>
                        </p>
                        <p className="card cardItem">
                            React.js{" "}
                            <img
                                src="https://i0.wp.com/www.primefaces.org/wp-content/uploads/2017/09/feature-react.png?ssl=1" alt='ReactJS'/>
                        </p>
                    </div>
                </section>
                ...
                >
                    ...
                    >
                        ...
                        <div className="whoRwe text-center">
                            <div className="card whoCard" style={{backgroundColor: 'rgba(255,255,255,0.8)'}}>
                    ...
                    <section>
                        <div className="whoRwe text-center">
                            ...
                            <div className="card whoCard" style={{backgroundColor: 'rgba(255,255,255,0.6)'}}>
