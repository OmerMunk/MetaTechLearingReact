                ...
                <ul>
                    <div className="flex sm-font">
                        <a href="/" className="Logo">
                            <img className="Logo" src="MetaIconColor.png" alt="MetaTechLogo"/>
                        </a>
                        ...
                        {token ? (
                                isAdmin?
                                    (<span><a className="links signArea" href='/admin_panel'>Admin Panel {firstName}</a><span className="signArea" > | </span> <a className="links signArea" onClick={signOutToggle}> Sign Out</a></span>)
                                    :
                                    ( <span>
